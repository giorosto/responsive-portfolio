...
function scrollActive(){
	...
	sections.forEach(current =>{
		...
		const div = document.querySelector('.nav__menu a[href*=' + sectionId + ']')
		console.log(div)
...
function scrollHeader(){
	...
	//shen the scroll is greater than 200 viewport height,add scroll-header class to the header tag
